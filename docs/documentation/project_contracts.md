...
4. `docs/context/tfm/current_status.md` (active TFM state; also summarizes
   how the inherited, closed TFG foundation in
   `docs/context/tfg/current_status.md` works)
5. The relevant issue document under `docs/roadmap/tfm/issues/` (TFM) or
   `docs/roadmap/tfg/issues/` (TFG, historical)
...
TFM (Trabajo de Fin de Master) built on top of it, with their documentation
physically separated into `docs/roadmap/tfg/` / `docs/context/tfg/` (closed)
and `docs/roadmap/tfm/` / `docs/context/tfm/` (active). See
...
- `docs/roadmap/tfm/tfm_roadmap.md`: active TFM roadmap overview
- `docs/roadmap/tfm/issues/*.md`: TFM per-issue execution records
- `docs/roadmap/tfm/hotfixes/*.md`: TFM maintenance and corrective records
- `docs/roadmap/tfg/cvn_generation_roadmap.md`: closed TFG roadmap overview,
  historical only
- `docs/roadmap/tfg/issues/*.md`: closed TFG per-issue execution records,
  historical only
- `docs/roadmap/tfg/hotfixes/*.md`: closed TFG maintenance and corrective
...
1. The relevant issue document under `docs/roadmap/tfm/issues/`
...
4. `docs/roadmap/tfm/tfm_roadmap.md` if roadmap state changed (never the closed
