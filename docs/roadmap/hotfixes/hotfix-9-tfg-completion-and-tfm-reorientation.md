...
- corrected `docs/memoria/estructura_memoria_tfg.md`: all eight chapter
  ...
  documents
- added a closure banner to the top of `docs/context/current_status.md`
  (retitled `# Current Status (TFG, Closed)`) and
  `docs/roadmap/cvn_generation_roadmap.md` (retitled
...
- created `docs/context/tfm_current_status.md`: the new active status log,
...
- created `docs/roadmap/tfm_roadmap.md`: the new active roadmap, carrying
...
- manually reviewed the updated entry-point files for a consistent reading
  ...
  `docs/context/project_context_index.md` ->
  `docs/context/tfm_current_status.md` -> the relevant TFM issue document,
...
- because the TFG roadmap/status files were frozen in place rather than
  ...
  (`docs/context/current_status.md` and `docs/context/tfm_current_status.md`)
  and two parallel roadmap files
  (`docs/roadmap/cvn_generation_roadmap.md` and
  `docs/roadmap/tfm_roadmap.md`). Every entry-point document was updated to
...
- all future TFM issue and hotfix documents should be added directly under
  `docs/roadmap/issues/` and `docs/roadmap/hotfixes/` alongside the existing
