...
1. update `docs/roadmap/tfg/issues/issue-13-normalization.md`
2. update `docs/context/tfg/current_status.md`
3. update `docs/roadmap/tfg/cvn_generation_roadmap.md`
...
- `docs/roadmap/tfg/issues/issue-13-normalization.md`
