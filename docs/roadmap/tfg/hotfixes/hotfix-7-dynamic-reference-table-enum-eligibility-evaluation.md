...
- `docs/roadmap/tfg/issues/issue-14-semantic-mapping-rules.md`
- `docs/context/tfg/current_status.md`
- `docs/pipeline/known_limitations.md` if a new limitation appears
- `docs/roadmap/tfg/cvn_generation_roadmap.md` if issue state changes
...
- Files involved:
  ...
  - `docs/roadmap/tfg/issues/issue-14-semantic-mapping-rules.md` during closure
- Subtask `10.1 / 15`:
...
- Subtask `13.3 / 15`:
  - update `docs/context/tfg/current_status.md` to mark hotfix `#7` implemented
- Subtask `13.4 / 15`:
...
- Subtask `13.5 / 15`:
  - update `docs/roadmap/tfg/cvn_generation_roadmap.md` if the hotfix state changes
