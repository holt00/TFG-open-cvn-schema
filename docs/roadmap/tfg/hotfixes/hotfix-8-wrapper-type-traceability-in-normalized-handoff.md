...
2. `H8-T09.2`: update `docs/context/tfg/current_status.md`
...
5. `H8-T09.5`: update
   `docs/roadmap/tfg/issues/issue-15-domain-model-generator.md` to remove or narrow
   the temporary limitation
6. `H8-T09.6`: update `docs/roadmap/tfg/cvn_generation_roadmap.md` if the hotfix
...
8. `H8-T09.8`: sweep `PROJECT_GUIDE.md`,
   `docs/context/project_context_index.md`, and `docs/context/tfg/current_status.md`
   for consistency
