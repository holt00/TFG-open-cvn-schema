...
- `docs/roadmap/tfg/issues/issue-11-project-infrastructure.md`
...
- `docs/roadmap/tfg/issues/issue-12-structural-bindings.md`
...
- `docs/roadmap/tfg/hotfixes/hotfix-1-runner-logging-convention.md`
...
- `docs/roadmap/tfg/hotfixes/hotfix-2-human-project-entrypoint.md`
...
- Planned authoritative record:
  - `docs/roadmap/tfg/issues/issue-26-epic-remaining-open-cvn-work.md`
...
- `docs/roadmap/tfg/issues/issue-44-generate-uml-or-uml-like-diagrams.md`
...
- current state: `docs/context/tfg/current_status.md`
