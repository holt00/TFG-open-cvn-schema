...
- Subtask 12.2: update `docs/context/tfg/current_status.md` so issue `#61` is recorded
  as complete and issue `#62` becomes the next implementation issue.
- Subtask 12.3: update `docs/roadmap/tfg/cvn_generation_roadmap.md` if it tracks issue
  `#61` status.
