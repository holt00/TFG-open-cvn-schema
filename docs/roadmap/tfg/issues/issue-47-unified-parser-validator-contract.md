...
11.3. Update `docs/context/tfg/current_status.md` with issue `#47` outcome and next
planned work.

11.4. Update `docs/roadmap/tfg/cvn_generation_roadmap.md` if issue `#47` status
changes.
