...
- Subtask 17.2: update `docs/context/tfg/current_status.md` so issue `#65` is recorded
  accurately and issue `#66` becomes the next implementation issue if `#65` is
  completed.
- Subtask 17.3: update `docs/roadmap/tfg/cvn_generation_roadmap.md` if it tracks issue
  `#65` status.
