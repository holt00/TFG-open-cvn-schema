...
- Expected files:
  - new issue or epic document under `docs/roadmap/tfg/issues/`
  - `docs/roadmap/tfg/cvn_generation_roadmap.md`
  - `docs/context/tfg/current_status.md`
...
- `docs/context/tfg/current_status.md` and
  `docs/roadmap/tfg/cvn_generation_roadmap.md` were updated to reflect the completed
