...
- issue `#61`: `docs/roadmap/tfg/issues/issue-61-application-mvp-scope-and-cli-shell.md`
- issue `#62`: `docs/roadmap/tfg/issues/issue-62-local-storage-sqlite-repository.md`
- issue `#63`: `docs/roadmap/tfg/issues/issue-63-master-and-derived-curriculum-versions.md`
- issue `#64`: `docs/roadmap/tfg/issues/issue-64-open-cvn-json-import-export-workflow.md`
- issue `#65`: `docs/roadmap/tfg/issues/issue-65-curriculum-editing-and-selection-mvp.md`
- issue `#66`: `docs/roadmap/tfg/issues/issue-66-latex-export-from-open-cvn.md`
- issue `#67`: `docs/roadmap/tfg/issues/issue-67-pdf-generation-and-preview-handoff.md`
- issue `#68`: `docs/roadmap/tfg/issues/issue-68-application-mvp-tests-and-documentation.md`
- issue `#69`: `docs/roadmap/tfg/issues/issue-69-llm-assisted-import-spike.md`
