...
- Subtask 13.2: update `docs/context/tfg/current_status.md` so issue `#63` is recorded
  accurately and issue `#64` becomes the next implementation issue if `#63` is
  completed.
- Subtask 13.3: update `docs/roadmap/tfg/cvn_generation_roadmap.md` if it tracks issue
  `#63` status.
