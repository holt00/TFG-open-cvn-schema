...
- Subtask 14.2: update `docs/context/tfg/current_status.md` with issue `#66` outcome.
...
- Subtask 14.5: update `docs/roadmap/tfg/cvn_generation_roadmap.md` if issue status
  changes there.
