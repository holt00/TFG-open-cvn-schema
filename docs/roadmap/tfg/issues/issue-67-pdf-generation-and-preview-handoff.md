...
- Subtask 14.8: update `docs/context/tfg/current_status.md` with issue `#67` outcome.
- Subtask 14.9: update `docs/roadmap/tfg/cvn_generation_roadmap.md` if issue status
  changes there.
