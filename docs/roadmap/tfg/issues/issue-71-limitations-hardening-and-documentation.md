...
- Modify `docs/context/tfg/current_status.md`.
- Modify `docs/roadmap/tfg/cvn_generation_roadmap.md`.
...
- Subtask 11.1: update `docs/context/tfg/current_status.md` with issue `#71` as the
  current or completed follow-up issue.
- Subtask 11.2: update `docs/roadmap/tfg/cvn_generation_roadmap.md` with issue `#71`
  status and scope.
...
- Subtask 13.4: update `docs/context/tfg/current_status.md` with the final issue `#71`
  result.
