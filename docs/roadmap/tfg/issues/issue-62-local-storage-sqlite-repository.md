...
- Subtask 14.2: update `docs/context/tfg/current_status.md` so issue `#62` is recorded
  accurately and issue `#63` becomes the next implementation issue if `#62` is
  completed.
- Subtask 14.3: update `docs/roadmap/tfg/cvn_generation_roadmap.md` if it tracks issue
  `#62` status.
