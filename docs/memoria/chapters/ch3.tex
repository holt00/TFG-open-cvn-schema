...
El paquete oficial descrito en esta sección no se obtuvo de una única vez. Se
solicitó directamente a FECYT el conjunto de artefactos técnicos del
ecosistema CVN, y la primera entrega recibida contenía únicamente el núcleo
mínimo de codificación: el manual de especificaciones, su versión
estructurada en XML, el modelo en árbol y los esquemas XSD centrales. El
desarrollo del proyecto comenzó sobre esa base. Al avanzar en la
normalización de metadatos descrita en el Capítulo~\ref{cap:pipeline}, sin
embargo, aparecieron de forma sistemática referencias del manual hacia
tablas de valores controlados que no tenían ningún artefacto correspondiente
en el paquete recibido. Comunicado este problema a FECYT, la fundación
confirmó que se trataba de una omisión en el envío inicial y remitió una
segunda entrega con las tres familias auxiliares ya presentadas: el catálogo
de entidades, las tablas de referencia y subtipos, y el tesauro
multilingüe. Esta circunstancia, más allá de la anécdota, tiene una
consecuencia directa sobre el diseño del sistema: ninguna etapa del pipeline
asume que el paquete oficial es completo o estable de antemano, sino que
cada referencia se resuelve con evidencia explícita precisamente porque, en
la práctica, el propio proceso de obtención del paquete ya demostró que
dicha evidencia puede llegar de forma incompleta o en momentos distintos.
