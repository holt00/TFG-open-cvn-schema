...
como punto de conexión con el dominio de aplicación. La descripción de sus fuentes,
su representación técnica y sus limitaciones se aborda de forma específica en el
capítulo siguiente, para evitar duplicar aquí el análisis que corresponde a la
...
No obstante, XML también presenta limitaciones cuando se utiliza como base directa
...
busca compatibilidad con tecnologías RDF u ontologías.

Sin embargo, la incorporación de semántica enlazada también aumenta la complejidad
