...
gestión automatizada de currículos}.
...
\begin{table}[htbp]
  ...
  \begin{tabular}{p{0.12\textwidth} p{0.58\textwidth} p{0.18\textwidth}}
    ...
    OE9 & Verificación automatizada y flujos reproducibles & 7 \\
    \hline
  \end{tabular}
...
la implementación de herramientas de validación, almacenamiento y exportación.
Estas tareas se han organizado de forma que cada capa conserve trazabilidad hacia
las fuentes originales y pueda verificarse mediante procedimientos reproducibles.
...
\begin{itemize}
  ...
  gestión.} Presenta el formato JSON propuesto, los parsers, validadores,
  mecanismos de almacenamiento local y flujos de exportación.
