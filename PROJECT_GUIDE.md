...
`docs/context/tfg/current_status.md`. Those files are frozen: read them for
...
3. `docs/context/tfm/current_status.md` (active TFM status; read
   `docs/context/tfg/current_status.md` separately for the closed TFG history)
4. the relevant issue document under `docs/roadmap/tfm/issues/` (TFM, active)
   or `docs/roadmap/tfg/issues/` (TFG, `#11`-`#71`, for historical foundation
   context)
...
- Do not edit or add new entries to the closed TFG documents
  ...
  `docs/roadmap/tfg/cvn_generation_roadmap.md`, the TFG issue files `#11`-`#71`,
  and the TFG hotfix files `#1`-`#8`) except to fix a factual error found
  after closure; TFM work is logged in
  `docs/context/tfm/current_status.md` and `docs/roadmap/tfm/tfm_roadmap.md`
  instead
...
- `docs/context/tfm/current_status.md`: active TFM implementation state and
  next steps; also explains how the inherited TFG foundation works
- `docs/context/tfg/current_status.md`: closed TFG implementation log (`#11`-`#71`);
...
- `docs/roadmap/tfg/issues/issue-08-epic-cvn-automation.md`: epic summary and
  checkpoints
- `docs/roadmap/tfg/issues/issue-11-project-infrastructure.md`: authoritative
  record of issue `#11`
- `docs/roadmap/tfg/issues/issue-12-structural-bindings.md`: authoritative record
  of issue `#12`
- `docs/roadmap/tfg/issues/issue-13-normalization.md`: authoritative record of issue
  `#13`
- `docs/roadmap/tfg/issues/issue-14-semantic-mapping-rules.md`: authoritative
  record of issue `#14`
...
- `docs/roadmap/tfg/issues/issue-48-cvn-pdf-xml-extraction.md`: authoritative
  record of issue `#48`
...
Each issue document under `docs/roadmap/tfg/issues/` (TFG) or
`docs/roadmap/tfm/issues/` (TFM) records:
...
1. read `docs/context/tfm/current_status.md` for the active TFM state (it
...
`docs/roadmap/tfg/issues/` (`#11`-`#71`); they are closed but remain the
